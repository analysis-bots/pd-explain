...
class GraphAutomatedExplorationVisualizer(SimpleAutomatedExplorationVisualizer):
    ...
    def __init__(self, history: pd.DataFrame, final_report, query_and_results: dict[int, QueryResultObject],
                 referenced_queries: list[int | str], query_tree: QueryTree,
        ...
        """
        super().__init__(history, final_report, query_and_results, query_tree, source_name,
                         beautify_fedex=beautify_fedex, beautify_metainsight=beautify_metainsight,
                         beautify_query_tree=beautify_query_tree, verbose=verbose)
