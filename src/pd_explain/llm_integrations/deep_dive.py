...
class DeepDive(LLMIntegrationInterface):
    ...
    def do_llm_action(self, user_query: str = None) -> Tuple[pd.DataFrame, str, dict]:
            ...
            for result in new_results:
                ...
                if result.error_occurred:
                    ...
                    try:
                        ...
                        query_and_results[result.index][result.generating_query].fedex = fedex_findings
                    ...
                    try:
                        ...
                        query_and_results[result.index][result.generating_query].metainsight = metainsight_findings
                    except Exception as e:
        ...
        final_report_system_message = ("You are part of an automated data exploration system on Pandas DataFrames. "
                                       "Your task is to generate a final report summarizing the findings from an automated analysis "
        ...
        return history, final_report, query_and_results
