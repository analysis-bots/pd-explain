...
class VisualizationBeautifier(LLMIntegrationInterface):
    ...
    def _describe_output_format(self) -> str:
        ...
        return ("The output must be a single Python code block, enclosed in <python> and </python> tags. "
                "The code should define a single entry function `create_visualization() -> Any` that takes the same parameters as the original visualization code "
    ...
    def do_llm_action(self) -> widgets.Tab:
        ...
        user_message: str = (
            ...
            f"Here is the visualization itself. Please improve it.\n\n"
        ...
        # Add the image to the message if it was created.
        if encoded_image:
