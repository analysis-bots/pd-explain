...
class CarouselAdapter(AdapterInterface):
    def __init__(self):
        ...
        self._current_output_widget: widgets.Output | None = None
    ...
    def __exit__(self, exc_type, exc_value, traceback) -> None:
        ...
        """
        # Ensure the last captured output is added if it wasn't explicitly done
        if self._current_output_widget and self._current_output_widget not in self._captured_outputs:
             self._captured_outputs.append(self._current_output_widget)
